...
- Target: `staging`
- Exact candidate identity: `28990f69ca2b6311bd120288668faa96b3828e12` (read back locally and from live PR 4 during this evidence refresh; candidate tree `9bda6926640701a37a931d76d078bd37dd03c6dd`).
...
| Hosted exact-head CI | GitHub Actions run `36073004280` on `28990f69ca2b6311bd120288668faa96b3828e12` | PASS: `django`, `ui-browser`, CodeRabbit, and GitGuardian all successful. The hosted `ui-browser` job runs Stage 2 only; it is not Stage 3 browser/reference evidence. Exact-head code review is complete; security review is still running, and the candidate still requires exact-candidate UI evidence and Rex acceptance. |
