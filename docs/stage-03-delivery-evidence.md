...
- Target: `staging`
- Exact implementation candidate at capture time: PR 5 head `4e41eed2f02021d9d363a92130c5d633172eac55` (`docs: record exact-head workspace acceptance evidence`). The onboarding capture run below was executed from this checked-out head before this document was amended again.
...
| Hosted exact-head CI | PR 5 live checks | PASS on exact head `4e41eed2f02021d9d363a92130c5d633172eac55`: `ui-browser`, `django`, `GitGuardian Security Checks`, and `CodeRabbit` all successful. The subsequent documentation-only amendment requires a fresh hosted run. |
